...
```{r, fig- scatter raw reproduction es vs longevity es}
#| fig-cap: Zoomed correlation between reproduction and longevity effect sizes

# Data in wide format
warm_wide <- subset(data, warm.cool=="Warm")
cool_wide <- subset(data, warm.cool=="Cool")

# Warm
plot(warm_wide$es_reproduction, warm_wide$es_longevity, xlim=c(-10,5), ylim=c(-10,5), 
     xlab="Reproduction effect size", ylab= "Longevity effect size")
abline(0,1)
abline(0,0)

# Cool
plot(cool_wide$es_reproduction, cool_wide$es_longevity, xlim=c(-10,10), ylim=c(-5,10),
     xlab="Reproduction effect size", ylab= "Longevity effect size")
abline(0,1)
abline(0,0)
