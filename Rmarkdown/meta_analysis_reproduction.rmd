...
meta_sa_treat2 <- rma.mv(es, VCV_shared_sa,  mod= ~ poly(treattemp, degree=2, raw=TRUE), random= list(~ 1|study_code, ~1|obs), data= sdata, method= "REML")
```
...
meta_sub_bintemp <- rma.mv(es, VCV_shared_subdata,  mod= ~bin.temp-1,  random= list(~ 1|study_code, ~1|obs), data= subdata, method= "REML")
```
