...
```{r, eval=FALSE, echo=FALSE}
meta_ga_treat2 <- rma.mv(es, VCV_shared_ga,  mod= ~ poly(treattemp, degree=2, raw=TRUE), random= list(~ 1|study_code, ~1|obs), test = "t", dfs = "contain", data= all_gdata, method= "REML")
```
...
```{r, eval=TRUE, echo=FALSE}
p <- bubble_plot(meta_ga_treat2, mod = "treattemp", group="study_code")
p+coord_cartesian(ylim=c(-10,10))
```
