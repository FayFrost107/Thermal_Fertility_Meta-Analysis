...
saveRDS(meta_precision, here("Output", "models", "longevity", "meta_rep_precision.rds"))
...
sdata <- subset(rdata, es > minq & es < maxq)
saveRDS(sdata, here("Output", "Output data", "longevity", "sensitivity_data_rep.rds"))
...
saveRDS(meta_sa_precision, here("Output", "models", "longevity", "meta_sa_precision.rds"))
  ...
  meta_precision <- readRDS(here("Output", "models", "longevity", "meta_rep_precision.rds"))
  sdata <- readRDS(here("Output", "Output data", "longevity", "sensitivity_data_rep.rds"))
...
saveRDS(meta_trait_treat2, here("Output", "models", "longevity", "meta_sa_treat2.rds"))
} else {
  meta_sa_treat2 <- readRDS(here("Output", "models", "longevity", "meta_sa_treat2.rds"))
  sa_data <- readRDS(here("Output", "Output data", "longevity", "sensitivity_data_long_sex.rds"))
}
...
sdata <- subset(new_data, es > minq & es < maxq)
saveRDS(sdata, here("Output", "Output data", "longevity", "sensitivity_data_rep_sex.rds"))
...
saveRDS(sdata, here("output", "Output data", "longevity", "pest_rep_sa_data.rds"))
  ...
  pest_rep_sa_data <- readRDS(here("Output", "Output data", "longevity", "pest_rep_sa_data.rds"))
}
