...
meta_sa_year2 <- rma.mv(es, VCV_shared_sa,  mod= ~poly(c_treattemp, degree=2, raw=TRUE), 
                         random= list(~ 1|study_code,  ~1|obs), data= sdata, method= "REML")

saveRDS(meta_sa_year2, here("Output", "models", "longevity", "meta_sa_year2.rds"))
} else {
  ...
  meta_sa_year2 <- readRDS(here("Output", "models", "longevity", "meta_sa_year2.rds"))
}
```
