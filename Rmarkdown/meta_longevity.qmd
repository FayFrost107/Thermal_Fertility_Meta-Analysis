...
We found that the was no significant difference in shape of the response to temperature between studies with both sexes exposed and those with only females exposed to treatments (*p*-value = `r p_value(meta_treat_sex$pval[6])`).   
...
No significant difference between longevity of animal when treat as adults versus treatment at immature stages.  
...
```{r, tbl-sactemp}
#| label: tbl-sactemp
#| tbl-cap: Non-linear effects of temperature on mean effect size of longevity having removed 5% of the most extreme effect sizes. 
table <- data.frame(Parameters = c("Longevity (mean)", "Linear Treatment Temperature (centered) - Longevity","Quadratic Treatment Temperature (centered) - Longevity", "Cubic Treatment Temperature (centered) - Longevity" ),
...
```{r, tbl-sasex}
#| label: tbl-sasex
#| tbl-cap: Non-linear effects of temperature and sex exposed on mean effect size of longevity with 5% most extreme effect sizes removed. 
table <- data.frame(Parameters = c("Linear Treatment Temperature (centered) - Both","Quadratic Treatment Temperature (centered) - Both", "Cubic Treatment Temperature (centered) - Both", "Both (mean)", "Females only (mean)", "Treatment Temperature (centered) - Females only","Quadratic Treatment Temperature (centered) - Females only", "Cubic Treatment Temperature (centered) - Females only"),
...
```{r, tbl-sals}
#| label: tbl-sals
#| tbl-cap: Non-linear effects of temperature and life stageo animal on mean effect size of longevity after removing the 5% most extreme effect sizes.
table <- data.frame(Parameters = c("Linear Treatment Temperature (centered) - Adult","Quadratic Treatment Temperature (centered) - Adult", "Cubic Treatment Temperature (centered) - Adult",  "Adult (mean)", "Immature (mean)", "Treatment Temperature (centered) - Immature","Quadratic Treatment Temperature (centered) - Immature", "Cubic Treatment Temperature (centered) - Adult"),
...
saveRDS(meta_trait_treat8, here("Output", "models", "longevity", "mv_rep_ctemp8.rds"))
  ...
  meta_trait_treat7  <- readRDS(here("Output", "models",  "longevity", "mv_rep_ctemp7.rds"))
  meta_trait_treat8  <- readRDS(here("Output", "models",  "longevity", "mv_rep_ctemp8.rds"))
}

r2_ml(meta_trait_treat4)
