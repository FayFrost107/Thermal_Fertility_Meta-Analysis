...
```{r, fig-figpest}
#| label: fig-figpest
#| fig-cap: Predicited Non-linear effects of temperature and pest status on mean effect size of reproduction. 
...
```{r, fig-figpestsa}
#| label: fig-figpestsa
#| fig-cap: Predicited Non-linear effects of temperature and pest status on mean effect size of reproduction (after removing outliers). 
