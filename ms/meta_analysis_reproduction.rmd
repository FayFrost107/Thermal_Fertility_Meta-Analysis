...
tree1 <- read.nexus(here::here("phylogeny", "all_reproduction_excHUM251_tree.nex"))
...
# Enters recalculated effect size sampling variances into diagonals
```
...
meta_sub_bintemp <- rma.mv(es, VCV_shared_subdata,  mod= ~bin.temp-1,  random= list(~ 1|study_code, ~ 1|shared_control, ~1|obs), data= subdata, method= "REML")
```
